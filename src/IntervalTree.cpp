...
Interval::Interval(std::string g, long st, long end, std::string t) {
    gene = g;
    start = st;
    stop = end;
    type = t;
...
IntervalTree::IntervalTree(std::vector<Interval> intervals, int depth, int minbucket, long extent_st , long extent_end,  int maxbucket){
...
std::vector<Interval> IntervalTree::find(long start, long stop){
...
std::vector<std::string> IntervalTree::find_gene(long start, long stop){
