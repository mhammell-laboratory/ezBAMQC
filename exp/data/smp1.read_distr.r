png("/sonas-hs/bsr/hpc/data/yjin/test_BAMqc/exp/test1/figs/smp1.read_distr.png",width=500,height=500,units="px")
M=c(24849,1533,16115,8729,205,453,7563,14335)
