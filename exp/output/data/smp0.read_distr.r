png("/sonas-hs/bsr/hpc/data/yjin/test_BAMqc/exp/test1/figs/smp0.read_distr.png",width=500,height=500,units="px")
M=c(24065,1500,15884,8486,169,452,8521,13287)
