        ...
        try:
            while(1):
                ...
                for (cur_read1,cur_read2) in cur_reads :
                    ...
                    #cur_time = time.time()
                    #print("time after ovp_gene + " + str(cur_time))
                    #calculate gene coverage
                    #gene = ""
                    #cds = utr5 = utr3 = intron = itgUp1k = itgDn1k = True
                    #if gene != "" :
                    #   sys.stderr.write("found gene "+gene+"\n")
                    cov_prof.count(gene,exons1,exons2)
                    #cur_time = time.time()
                    #print("time after cov count + " + str(cur_time))
