    ...
    def write(self,total_read):
        ...
        if len(self.mapqlist) > 0 :
            try :
                ...
                print >>ROUT, 'plot(mapq_val,( mapq_count/'+str(total_read)+'),pch=20,xlab="Mapping Quality Score",ylab="Frequency",col="blue")\n'
                print >>ROUT, 'abline(h=0,v=' + str(self.q_cutoff) + ', lty=2)\n'
                print >>ROUT, "dev.state=dev.off()\n"
                ROUT.close()
            except :
